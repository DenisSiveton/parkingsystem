...
public class DBConstants {
    ...
    public static final String CHECK_HISTORY_CUSTOMER = "select * from ticket t where t.VEHICLE_REG_NUMBER = ? and t.OUT_TIME IS NOT NULL order by t.IN_TIME DESC limit 1";
}
